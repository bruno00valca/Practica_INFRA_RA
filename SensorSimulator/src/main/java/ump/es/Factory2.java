...
public class Factory2 implements Runnable{
    ...
    public void run() {
        ...
        while (true) {
            sendSensorData("factory2-temp-001", SensorType.TEMPERATURE, "temp_min", "temp_max");
            sendSensorData("factory2-hum-001", SensorType.HUMIDITY, "hum_min", "hum_max");
            sendSensorData("factory2-co2-001", SensorType.CO2, "co2_min", "co2_max");
            sendSensorData("factory2-voc-001", SensorType.VOC, "voc_min", "voc_max");
